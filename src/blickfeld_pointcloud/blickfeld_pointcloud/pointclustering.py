...
class PCPub(Node):
    ...
    def publish_point_cloud(self):
        ...
        if self.pointRANSAC is not None:
            ...
            msg.height = self.pointRANSAC.shape[0]
            msg.width = 1  # self.pointRANSAC.shape[1]

            byteSizePerPoint = self.pointRANSAC[0, 0].itemsize #4
            numberOfInfoPerPoint = len(self.pointRANSAC[0])  # xyz = 3, xyzrgb = 6
            ...
            msg.row_step = byteSizePerPoint * numberOfInfoPerPoint * self.pointRANSAC.shape[0]
            msg.data = self.pointRANSAC.tobytes()
